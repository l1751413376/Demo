                            ...
                            if ((num5 == -1) || (this.mOpen[num5].G > num4))
                            {
                                ...
                                if ((num7 == -1) || (this.mClose[num7].G > num4))
                                {
                                    ...
                                    switch (this.mFormula)
                                    {
                                        ...
                                        {
                                            int introduced26 = Math.Abs((int) (node2.X - ((int) end.X)));
                                            node2.H = this.mHEstimate * Math.Max(introduced26, Math.Abs((int) (node2.Y - ((int) end.Y))));
                                            break;
                                        }
                                        case HeuristicFormula.DiagonalShortCut:
                                        {
                                            int introduced27 = Math.Abs((int) (node2.X - ((int) end.X)));
                                            int num8 = Math.Min(introduced27, Math.Abs((int) (node2.Y - ((int) end.Y))));
                                            int introduced28 = Math.Abs((int) (node2.X - ((int) end.X)));
                                            int num9 = introduced28 + Math.Abs((int) (node2.Y - ((int) end.Y)));
                                            node2.H = ((this.mHEstimate * 2) * num8) + (this.mHEstimate * (num9 - (2 * num8)));
                                            break;
                                        }
                                        case HeuristicFormula.Euclidean:
                                        {
                                            double introduced29 = Math.Pow(node2.X - end.X, 2.0);
                                            node2.H = (int) (this.mHEstimate * Math.Sqrt(introduced29 + Math.Pow(node2.Y - end.Y, 2.0)));
                                            break;
                                        }
                                        case HeuristicFormula.EuclideanNoSQR:
                                        {
                                            double introduced30 = Math.Pow(node2.X - end.X, 2.0);
                                            node2.H = (int) (this.mHEstimate * (introduced30 + Math.Pow(node2.Y - end.Y, 2.0)));
                                            break;
                                        }
                                        ...
                                        default:
                                        {
                                            int introduced25 = Math.Abs((int) (node2.X - ((int) end.X)));
                                            node2.H = this.mHEstimate * (introduced25 + Math.Abs((int) (node2.Y - ((int) end.Y))));
                                            break;
                                        }
                                    }
                                    if (this.mTieBreaker)
